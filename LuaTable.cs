...
namespace UniLua
{
    ...
    public class LuaTable
    {
        ...
        public TValue Get(ref TValue key)
        {
		...
		*/
        private int FindIndex(TValue key)
        {
            if (key.V.TtIsNil())
            { return -1; }
		...
		*/
        ...
        private TValue NewTableKey(ref TValue k)
        {
